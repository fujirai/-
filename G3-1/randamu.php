...
<div id="popup" class="popup">
    ...
    <p><h3>
        ...
        <span class="<?php echo ($stat_changes['trust'] > 0) ? 'stat-up' : (($stat_changes['trust'] < 0) ? 'stat-down' : ''); ?>"><?php echo $stat_changes['trust']; ?></span><br>
        技術力：<span><?php echo $user['technical_skill']; ?></span> 
        <span class="<?php echo ($stat_changes['technical'] > 0) ? 'stat-up' : (($stat_changes['technical'] < 0) ? 'stat-down' : ''); ?>"><?php echo $stat_changes['technical']; ?></span><br>
        交渉力：<span><?php echo $user['negotiation_skill']; ?></span> 
        <span class="<?php echo ($stat_changes['negotiation'] > 0) ? 'stat-up' : (($stat_changes['negotiation'] < 0) ? 'stat-down' : ''); ?>"><?php echo $stat_changes['negotiation']; ?></span><br>
        容姿：<span><?php echo $user['appearance']; ?></span> 
        <span class="<?php echo ($stat_changes['appearance'] > 0) ? 'stat-up' : (($stat_changes['appearance'] < 0) ? 'stat-down' : ''); ?>"><?php echo $stat_changes['appearance']; ?></span><br>
        好感度：<span><?php echo $user['popularity']; ?></span> 
        <span class="<?php echo ($stat_changes['popularity'] > 0) ? 'stat-up' : (($stat_changes['popularity'] < 0) ? 'stat-down' : ''); ?>"><?php echo $stat_changes['popularity']; ?></span><br>
    </h3></p>
</div>
